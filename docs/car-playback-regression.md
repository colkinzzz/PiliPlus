...
- Next/previous media buttons are debounced. Navigation interruption can duck or
  pause; manual pause wins over later focus gain. Volume restoration affects only
  the player output and respects volume changes made during the interruption.
...
3. Interrupt playback with navigation and a call; test both navigation preferences,
